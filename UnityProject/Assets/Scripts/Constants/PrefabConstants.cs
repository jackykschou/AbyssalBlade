...
namespace Assets.Scripts.Constants
{
    ...
    public class PrefabConstants
    {
        ...
        private static readonly Dictionary<Prefab, string> PrefabPathMap = new Dictionary<Prefab, string>()
        {
            ...
            {Prefab.SurvivalArea1, "Prefabs/PreloadedPrefab/Level/SurvivalArea1Section2"},
            {Prefab.SurvivalArea2, "Prefabs/PreloadedPrefab/Level/SurvivalArea2Section2"},
            {Prefab.SurvivalArea3, "Prefabs/PreloadedPrefab/Level/SurvivalArea3Section2"},
            {Prefab.SurvivalArea4, "Prefabs/PreloadedPrefab/Level/SurvivalArea4Section2"},
            {Prefab.SurvivalArea5, "Prefabs/PreloadedPrefab/Level/SurvivalArea5Section2"},
            {Prefab.SurvivalArea1, "Prefabs/PreloadedPrefab/Level/SurvivalArea1Section3"},
            {Prefab.SurvivalArea2, "Prefabs/PreloadedPrefab/Level/SurvivalArea2Section3"},
            {Prefab.SurvivalArea3, "Prefabs/PreloadedPrefab/Level/SurvivalArea3Section3"},
            {Prefab.SurvivalArea4, "Prefabs/PreloadedPrefab/Level/SurvivalArea4Section3"},
            {Prefab.SurvivalArea5, "Prefabs/PreloadedPrefab/Level/SurvivalArea5Section3"},
